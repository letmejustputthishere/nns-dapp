...
export async function get_set_authorized_subnetworks_proposal(identity: SignIdentity): Promise<void> {
...
export async function vote_for_authorized_subnetworks_proposal(identity: SignIdentity): Promise<void> {
...
export async function test_canisters(identity: SignIdentity): Promise<void> {
    const serviceApi = new ServiceApi(identity);
...
export async function test_happy_path(identity: SignIdentity): Promise<void> {
    ...
    await create_dummy_proposals(identity, firstNeuronId);
...
export async function create_dummy_proposals(identity: SignIdentity, neuronId: NeuronId) : Promise<void> {
